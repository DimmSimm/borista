    ...
    return (
        <section className='mobile-header'>
            <div className='mobile-header-wrapper'>
                <div className='mobile-header-main-items'>
                    {children}
                    <div className="mobile-header__logo nav-main-items">
                ...
                <div className="mobile-header-phones mobile-header-main-items">
					<div className="phones__phones-wrapper">
						<a className="phones__phone-link phones__phone-first dark_link banner-light-text menu-light-text icon-block__name" href="tel:+79080586755">
